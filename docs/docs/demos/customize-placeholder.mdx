...
sidebar_label: Customize Placeholder
title: ""
...
import { Sample } from "@site/src/components/demos/customize-placeholder";

This demo shows how to customize the placeholder. Drag an item to see the custom placeholder in action.
...
<Details style={{ marginTop: 24 }}>
  ...
  <Tabs groupId="language-choice">
    <TabItem value="tsx" label="customize-placeholder.tsx">
      ```tsx
