...
sidebar_label: Window Constraint
title: ""
...
import { Sample } from "@site/src/components/demos/window-constraint";

This demo shows how to restrict dragging within the window. Items cannot be moved beyond the viewport boundaries.
...
<Details style={{ marginTop: 24 }}>
  ...
  <Tabs groupId="language-choice">
    <TabItem value="tsx" label="window-constraint.tsx">
      ```tsx
